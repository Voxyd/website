        ...
        <section id="security">
            ...
            <div class="paragraph">
                ...
                <div class="content">
                    ...
                    <span class="description"><p><?php echo $this->txt->security->filesEncryptionTxt; ?></p></span>
                </div>
            </div>
            
            <div class="paragraph">
                <div class="title"><?php echo $this->txt->security->SwissLaws; ?></div>
                <div class="content">
                    <span class="description"><p><?php echo $this->txt->security->SwissLawsTxt; ?></p></span>
