    ...
    <body>
        ...
        <section id="security">
            ...
            <div class="paragraph">
                ...
                <div class="content">
                    <span class="image"><img src="./public/pictures/security/gnupg.png" alt="GnuPG" /></span>
                    <span class="description"><p>Nous utilisons le chiffrement de bout-en-bout. Cela signifie que quelque soit le stade (upload, stockage, download), votre fichier sera toujours chiffré. Ainsi, si une interception a lieu, l'attaquant ne pourra jamais lire vos fichiers. L'algorithme de chiffrement utilisé est <b>RSA</b> via <a href="https://www.gnupg.org/">GnuPG</a> (qui est une implémentation complète et opensource de OpenPGP) qui permet <b>un chiffrement sur 4096 bits</b>. Lors de la création de son compte, l'utilisateur se voit attribuer une clé personnelle et unique afin de pouvoir chiffrer et déchiffrer ses fichiers. Les clés personnelles des utilisateurs seront ensuite chiffrées sur le serveur à l'aide des paraphrases des utilisateurs (connues par eux seuls). Ainsi, <b>vous serez les seuls à pouvoir déchiffrer votre clé personnelle et vos fichiers</b>. Nous ne pouvons pas déchiffrer vos fichiers. Pour chiffrer vos fichiers avant l'upload, votre clé personnelle (et chiffrée) vous sera envoyé en local, puis sera déchiffrée (au niveau du navigateur) pour enfin chiffrer vos fichiers.<br /><a style="cursor: pointer;" onclick="draw();">Ouvrir le schéma de fonctionnement</a></p></span>
                </div>
            </div>
